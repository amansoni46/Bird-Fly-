...
def create_bird_surface():
    ...
    # Head
    pygame.draw.circle(surface, BROWN, (25, 25), 20)

    # Ears
    pygame.draw.circle(surface, BROWN, (5, 25), 8)
    pygame.draw.circle(surface, BROWN, (45, 25), 8)
    pygame.draw.circle(surface, LIGHT_BROWN, (5, 25), 5)
    pygame.draw.circle(surface, LIGHT_BROWN, (45, 25), 5)

    # Face
    pygame.draw.ellipse(surface, LIGHT_BROWN, (15, 20, 20, 20))

    # Eyes
    pygame.draw.circle(surface, WHITE, (18, 20), 4)
    pygame.draw.circle(surface, WHITE, (32, 20), 4)
    pygame.draw.circle(surface, BLACK, (18, 20), 2)
    pygame.draw.circle(surface, BLACK, (32, 20), 2)

    # Nose
    pygame.draw.circle(surface, BLACK, (24, 30), 1)
    pygame.draw.circle(surface, BLACK, (26, 30), 1)

    # Mouth
    pygame.draw.arc(surface, BLACK, (20, 30, 10, 10), 3.14, 2 * 3.14, 1)
